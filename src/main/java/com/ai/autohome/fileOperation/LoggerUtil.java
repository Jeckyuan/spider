...
public class LoggerUtil {
	...
	public static void main(String[] args){
		...
		String dtNow = new SimpleDateFormat("yyyyMMddHHmmss").format(new Date());
		
		String logName = "test_log_"+dtNow;
		
		Logger logger = LoggerUtil.getLoggerByName(logName);
	 ...
	 public static Logger getLoggerByName(String name) {  
	        ...
	        appender.setFile(usrDir + "/logs/" + name + ".log");  
	        // log的文字码  
