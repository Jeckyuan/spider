...
import weibo.WeiboHTMLAnalysis;
 ...
 * @create 2015年12月18日
 */
public class TestHttpClientWeibo {

	public static Logger logger = Logger.getLogger(TestHttpClientWeibo.class);
	
    private static final int timeOut = 15 * 1000;
    
    private static final String TC_Page_G0="TC-Page-G0";
    
    private static String TC_Page_G0_Val="b05711a62e11e2c666cc954f2ef362fb";
...
//                "http://dict.youdao.com/",
    ...
    static class GetRunnable implements Runnable {
        ...
        public void run() {
            try {
            	String[] st=TestHttpClientWeibo.get(url, true);
//            	System.out.println(st[0]);
            	System.out.println(st[1]);
//            	System.out.println(st[2]);
//                System.out.println(TestHttpClientWeibo.get(url));
            } finally {
